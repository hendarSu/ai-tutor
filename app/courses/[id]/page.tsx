...
export default function CourseDetailPage() {
  ...
  const totalLessons = course.sections.reduce((acc: any, section: any) => acc + section.subsections.length + 1, 0)
  ...
  const handleMarkAsDone = () => {
    ...
    const progress = Math.round((newCompletedLessons.size / totalLessons) * 100)
    ...
    <div className="min-h-screen flex flex-col bg-background">
      <div className="border-b">
        <div className="container py-4">
          <Button variant="ghost" onClick={() => router.push("/")} className="flex items-center text-muted-foreground">
        ...
        >
          <div className="h-full flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto">
              {course.sections.map((section: any, sectionIndex: any) => (
